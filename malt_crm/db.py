...
def make_database_url(database: Union[str, Path]) -> str:
...
def get_engine(database: Union[str, Path]) -> Engine:
...
def create_session_factory(database: Union[str, Path]) -> sessionmaker[Session]:
